...
public class AsyncSocketServer {
    ...
    class ReadWriteHandler implements CompletionHandler<Integer, Map<String, Object>> {
        ...
        public String sendMessageBack(String message) throws IOException, InterruptedException, ExecutionException {
            byte[] byteMsg = new String(message).getBytes();
            ByteBuffer buffer = ByteBuffer.wrap(byteMsg);
            Future<Integer> writeResult = ((AsynchronousByteChannel) serverChannel).write(buffer);

            writeResult.get();
            buffer.flip();
            Future<Integer> readResult = ((AsynchronousByteChannel) serverChannel).read(buffer);
